    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(IndividualRegistration.this,LoginActivity.class);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String genders = gender.getSelectedItem().toString();
                ...
                if(gender.equals("Select Gender")){
                    Toast.makeText(IndividualRegistration.this, "Select Gender", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(IndividualRegistration.this, "Error" + error, Toast.LENGTH_SHORT).show();
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(IndividualRegistration.this, "Data set successfully", Toast.LENGTH_SHORT).show();
                                        }else {
                                            Toast.makeText(IndividualRegistration.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                if (resultUri !=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(IndividualRegistration.this, "Image Upload", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(IndividualRegistration.this, "Image url added to database successfully", Toast.LENGTH_SHORT).show();
                                                                }else {
                                                                    Toast.makeText(IndividualRegistration.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                    ...
                                    Intent intent = new Intent(IndividualRegistration.this,MainActivity2.class);
                                    startActivity(intent);
                                    finish();
                                }
                            }
